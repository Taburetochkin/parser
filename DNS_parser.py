...
def parse_characteristics_page(driver, url):
    ...
    pictures_soup = soup.find_all('img', class_="product-images-slider__img")
    ...
    notebook["Наименование"] = name.text
    ...
    notebook["Лист с картинками"] = pictures_list if pictures_list else "У товара нет изображений" 
    notebook["Главное изображение"] = pictures_list[0] if pictures_list else "У товара нет изображений"
...
def main():
    ...
    urls_to_parse = [
        ...
        'https://www.dns-shop.ru/catalog/17aa236e16404e77/ledogeneratory/?p={page}',
